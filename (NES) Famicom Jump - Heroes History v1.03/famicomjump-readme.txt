...
Famicom Jump - Heroes History (English v1.03).ips
--This patch requires a clean an unaltered "Famicom Jump: Eiyuu Restuden" ROM (IPS Format)
Famicom Jump - Heroes History (English v1.03).bps
--This patch requires a clean an unaltered "Famicom Jump: Eiyuu Restuden" ROM (BPS Format)

Be sure to use either IPS or BPS patch on a ROM with the following hashes.  (Don't use both patches.)

File SHA-1: FC99B28E592ABD17AF7D9F4CC0A5F0F12442888B
File CRC32: 80B4C1DE
...
The following edits were made into the game's text
...
1.  Fixed line spoken by Kenichi (Moeru! Oniisan)
2.  Fixed line spoken by Cancer Deathmask (Saint Seiya)
3.  Changed "evading" to "dodging" in text leading to Saga fight
4.  Fixed text leading to Kiku Fight mini-game
5.  Fixed Cavery210's name in end credits
